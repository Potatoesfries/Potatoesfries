...
-  I’ve built a **[Spotify clone](https://spotify-aeyt.onrender.com)** for music streaming and messaging. Check the repository **[Spotify clone](https://github.com/Potatoesfries/Spotify)**.
-  Also built an e-commerce application, A fully functional, professional e-commerce application built with a Flutter frontend, Node.js/Express backend. Repository **[E-commerce](https://github.com/Potatoesfries/E-commerce-Clone)**.
